//! Provider-neutral World IR, meaning holes, and fitted tables.
//!
//! Owned here (T2) so T3 providers and T5 lab-core do not climb to T6.
...
impl WorldIr {
    ...
    pub fn identity(&self) -> WorldId {
        WorldId(emath_core::fnv1a64_bytes(self.canonical().as_bytes()))
    }
