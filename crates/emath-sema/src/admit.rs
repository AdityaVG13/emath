        ...
        match &expr.kind {
            ...
            ExprKind::Call { function, args } => {
                ...
                let arity: Option<usize> = match name.as_str() {
                    ...
                    "min" | "max" | "atan2" | "pow" | "mod" | "hypot" | "dot" | "laplacian" | "laplacian_neumann" | "laplacian_2d" | "laplacian_2d_neumann" => Some(2),
                    "lerp" | "clamp" => Some(3),
