...
| [modular-arithmetic.emath](intro/modular-arithmetic.emath) | Parses. `Mod<p>`/`GF<p>` types, `factorial`, `mod_inv`, `cong`, `poly_eval_mod`, `rs_encode` — finite field arithmetic and RS code construction (B15/B29/B40). |
