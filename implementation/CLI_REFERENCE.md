...
| Command | Behavior |
| --- | --- |
| `emath agent check\|plan\|build <file> [--out <dir>]` | `emath.agent.v1` over the same session/build paths; an agent cannot bypass admission, planning, or artifact checks |
